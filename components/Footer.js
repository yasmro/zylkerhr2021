        ...
        <footer class="bg-gray-50 text-gray-600 body-font">
            ...
            <div class="bg-white">
                ...
                <a href="#" class="flex title-font font-medium items-center md:justify-start justify-center text-gray-900">
                    <span class="ml-3 text-xl"><Image alt="ジルカーHR" src={"/images/zylker-hr.png"} width={120} height={40} /></span>
                </a>
                <p class="text-sm text-gray-500 sm:ml-6 sm:mt-0 mt-4">© {new Date().getFullYear()} Zylker HR —
                    <a href="#" rel="noopener noreferrer" class="text-gray-600 ml-1" target="_blank">@ZylkerHR</a>
                </p>
