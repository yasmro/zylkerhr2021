      ...
      <main>
        ...
        <section class="mx-auto py-12 px-4 sm:px-6 lg:py-24 lg:px-24 text-gray-600 body-font">
          <div class="container px-5 py-24 mx-auto">
            <h1 class="sm:text-4xl text-2xl font-bold title-font text-center text-gray-900 mb-20">
        ...
        <section className="mx-auto py-12 px-4 sm:px-6 lg:py-24 lg:px-24">
          <h2 className="text-2xl text-center font-extrabold tracking-tight text-gray-900 lg:text-4xl mb-0">
